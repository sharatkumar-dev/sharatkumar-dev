...
## 🚀 What I Do
- 💻 Build **modern, high-performance web applications**
- 🎨 Design **clean, conversion-focused UI/UX**
- ⚡ Combine **development + design thinking** for better results
- 📈 Focus on **speed, scalability, and user experience**

---

## 💼 Services (Freelance Ready)
- 🌐 Custom Website Development (Next.js / React)
- 🎨 UI/UX Design (Figma, Adobe)
- 🛒 E-commerce Experiences (High-conversion layouts)
...
> 🔒 Selected client work (details limited for privacy)
...
- Strong **UI/UX + development combo**
- Clean, scalable, and fast solutions
...
## 💡 Philosophy
> Good design attracts. Great experience converts.
